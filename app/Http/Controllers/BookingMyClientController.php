...
class BookingMyClientController extends Controller {
    ...
    public function index(Request $request) {
        $query = User::query()->selectRaw('users.*,
        ...
        return response(fractal($myClients,
                                new MyClientTransformer())->parseIncludes($request->getIncludes()))->withPaginationHeaders($paginator);
    }
    ...
    public function upcoming(Request $request) {
        ...
        return response(fractal($schedules, new MyClientUpcomingTransformer())->parseIncludes($request->getIncludes())
    ...
    public function closed(Request $request) {
        ...
        return response(fractal($bookings, new MyClientClosedTransformer())->parseIncludes($request->getIncludes())
                                                                           ->toArray())->withPaginationHeaders($paginator);
    }
    ...
    public function purchases(Request $request) {
        ...
        return response(fractal($purchases,
                                new MyClientPurchaseTransformer())->parseIncludes($request->getIncludes()))->withPaginationHeaders($paginator);
    }
}
