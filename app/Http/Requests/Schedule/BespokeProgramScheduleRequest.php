...
class BespokeProgramScheduleRequest extends GenericSchedule
{
    ...
    public function rules()
    {
        return [
            ...
            'deposit_instalment_frequency' => 'required_if:deposit_accepted,true|min:1|integer|max:31',
            'deposit_instalments'          => 'required_if:deposit_accepted,true|min:1|integer|max:100',
