...
The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> As requested, your {{platform_name}} Business Profile page
...
Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'subject'    => '{{service_name}} Booking Schedule is Live!',
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> Your Booking Schedule is live for {{service_name}} on {{platform_name}} and is ready for Clients to book.
...
Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> Your Retreat\'s Booking Schedule is live for {{service_name}}
...
We are excited to be empowering your business. <br/> <br/> Thank you  <br/>The {{platform_name}} Team <br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //15
            [
...
<br/><br /><a href="{{my_services}}" target="_blank">Go To My Services</a><br /><br/><br/> Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //16
            [
...
Thank you<br/>
 The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}} <br/>Welcome to the {{platform_name}} - {{subscription_tier_name}} Subscription Plan.
...
You can also upgrade your subscription at any time from your Account section.
 ...
 We are excited to empower you in your business. <br/><br/>Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //19
            [
...
Thank you<br/> The {{platform_name}}  Team<br/></td></tr>',
 ...
 <br/><br/>Thank you<br/> The {{platform_name}}  Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> This is to confirm {{article_name}} is now unpublished on {{platform_name}}
...
<br/><br/> Thank you
<br/>The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //22
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/>
 {{schedule_name}} has now been cancelled for {{service_name}}.<br/><br/> Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //23
            [
...
Please make sure you have funds are available to cover this refund.<br/><br/> Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //26
            [
                ...
                'subject'    => 'Booking Cancelled – {{service_name}}',
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> Your booking for {{service_name}} with {{practitioner_business_name}}
...
Booking Reference: {{booking_reference}}<br/><br/>
 Thank you <br/> The {{platform_name}} Team <br/></td></tr>',
            ...
            [
                ...
                'subject'    => 'Booking Cancelled – {{service_name}}',
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}} <br/> Unfortunately, {{client_name}} has had to cancel their booking with you for {{service_name}} {{schedule_name}}.
...
We recommend getting in touch with {{client_name}} directly via {{platform_name}} messaging to welcome them and provide any further information they may need for {{service_name}}.
 <br/>{{view_booking}} <br/> <br/>  Thank you <br/> The {{platform_name}} Team <br/> <br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            //36
            [
...
<br/><br/>Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> We thought you may like to know that {{service_name}} which you have booked with {{practitioner_business_name}} has been updated.
...
<br/>Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> You are currently booked with {{practitioner_business_name}} for {{service_name}}.
...
Thank you<br/> The {{platform_name}} Team <br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}} <br/>Your Retreat, {{service_name}} with {{practitioner_business_name}} is just two weeks away. <br/>
Booking Details: {{service_name}} - {{schedule_name}}<br/>
Booking Reference: {{booking_reference}} <br/>
From: {{schedule_start_date}}<br/>
To: {{schedule_end_date}} <br/>
...
Location:  {{schedule_venue_name}} {{schedule_venue_address}} {{schedule_city}}, {{schedule_postcode}} {{schedule_country}}
<br/>{{see_on_map}}<br/>
<a href="{{view_bookings}}" target="_blank">View My Bookings</a><br/><br/> Thank you <br/>The {{platform_name}} Team<br/></td></tr>',
                'delay'      => random_int(5, 20)
            ],
            /*
             *
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> You are currently booked with {{practitioner_business_name}} for {{service_name}} on the {{schedule_start_date}}.<br/>
 ...
 <a href="{{view_booking}}" target="_blank">View My Bookings</a><br/><br/>
  Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> We are pleased to confirm your Client {{client_name}} has accepted the change for {{service_name}}.<br/><br/>
...
Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> Unfortunately, your Client {{client_name}} has declined the reschedule for {{service_name}}.
...
Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
            ...
            [
                ...
                'logo'       => Str::random(5),
                'text'       => '<tr><td>Hi {{first_name}}<br/> Unfortunately, {{practitioner_business_name}} had to change the booking details for {{service_name}} - {{schedule_name}}.
...
<br/> Thank you<br/> The {{platform_name}} Team<br/></td></tr>',
             ...
             * {{instalment_date_1}} – {{instalment_amount_1}}<br/>
             * {{instalment_date_2}} – {{instalment_amount_2}}<br/>
             * {{etc_for_number_of_instalments}}<br/><br/> Thank you<br/> The {{platform_name}}  Team<br/></td></tr>',
             * 'delay'      => random_int(5, 20)
             * ],
             * //21
             * [
             ...
             * Please make sure you have funds available for each instalment or your Booking may be cancelled. <br/><br/>Thank you<br/> The {{platform_name}}  Team<br/></td></tr>',
             * 'delay'      => random_int(5, 20)
             * ],
             * //40
             * [
